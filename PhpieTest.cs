...
// internal interface ITest
    ...
    public class PhpieTest
    {
        ...
        private string privateA = String.Empty;
        private static string privateB = String.Empty;

        private protected string privateProtectedA = String.Empty;
        private protected static string privateProtectedB = String.Empty;

        public string __A1 { get; }
        public string __A2 { init; get; }
        public string __A3 { set; get; }
        public static string __B { set; get; }
        protected string __ProtectedA { set; get; }
        protected static string __ProtectedB { set; get; }
        private string __PrivateA  { set; get; }
        private static string __PrivateB { set; get; }   
        private protected string __PrivateProtectedA { set; get; }
        private protected static string __PrivateProtectedB { set; get; }
